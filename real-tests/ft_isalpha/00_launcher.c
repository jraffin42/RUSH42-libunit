...
int	ft_isalpha_launcher(void)
{
	...
	static t_test	test_list[] = {
		(t_test){"basic_test_1", &ft_isalpha_basic_test_1},
		(t_test){"basic_test_2", &ft_isalpha_basic_test_2},
		(t_test){"basic_test_3", &ft_isalpha_basic_test_3},
		(t_test){"basic_test_4", &ft_isalpha_basic_test_4},
		(t_test){NULL, NULL}
	};

	unit_test.function_name = "ft_isalpha";
