...
int	ft_isalnum_launcher(void)
{
	...
	static t_test	test_list[] = {
		(t_test){"basic_test_1", &ft_isalnum_basic_test_1},
		(t_test){"basic_test_2", &ft_isalnum_basic_test_2},
		(t_test){"basic_test_3", &ft_isalnum_basic_test_3},
		(t_test){"basic_test_4", &ft_isalnum_basic_test_4},
		(t_test){NULL, NULL}
	};
